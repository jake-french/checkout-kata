...
- I chose the `TryScan` pattern over custom exceptions to give developers explicit, compile-time visibility into both the
  success and failure paths. In a real-world checkout system, smudged or missing barcodes are expected operational
